...
abstract class FavoritiesStore with Store {
  ...
  _getFromStorage() async {
    ...
    if (favQuotes != "") {
      favIdsList = ObservableList.of([]);
      favQuotesList = ObservableList.of([]);
  ...
  @observable
  ObservableList<int> favIdsList = ObservableList.of([]);

  @observable
  ObservableList<Quote> favQuotesList = ObservableList.of([]);
